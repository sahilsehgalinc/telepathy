...
/**
 * The <code>UserDeletedException</code> class handles exceptions that can occur while authenticating a User
 * @author TS
 * 
 */
public class UserDeletedException extends Exception {
	 ...
	 *            java.lang.String
	 */
	public UserDeletedException(String s) {
		super(s);
	}
	 ...
	 *            java.lang.Throwable
	 */
	public UserDeletedException(String s, Throwable cause) {
		super(s, cause);
	}
}